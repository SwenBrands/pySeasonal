...
if len(sys.argv) > 1:
    ...
    vers = 'v1m_test' #version number of the output netCDF file to be sent to Predictia; will be extended by "_mon" or "_seas" depending on whether 1-month or 3-month values will be verified
    models = ['eccc5'] #['cmcc35','ecmwf51'] list of models and versions thereof
            ...
            for det in np.arange(len(detrending)):
                for vv in np.arange(len(variables_gcm)):       
                    ...
                    for oo in np.arange(len(obs)):
                        ...
                        upper_tercile_obs_step = (obs_seas_mn_5d >= t1_obs).astype(precision)
...
flagfile = dir_flag+'/get_skill_season_'+str(vers)+'_'+str(models)+'_obs_'+str(variables_obs)+'_model_'+str(variables_gcm)+'_'+str(agg_labels)+'_'+str(modulators)+'_'+str(phases)+'.flag'

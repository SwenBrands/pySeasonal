        ...
        for det in np.arange(len(detrending)):
            for vv in np.arange(len(variables_gcm)):       
                ...
                for oo in np.arange(len(obs)):
                    ...
                    if modulator == 'enso':
                        savename_results = dir_netcdf_agg+'/validation_results_season_'+variables_gcm[vv]+'_'+agg_label[ag]+'_'+model[mm]+'_vs_'+obs[oo]+'_'+domain+'_corroutlier_'+corr_outlier+'_detrended_'+detrending[det]+'_'+str(years_common2label[0])+'_'+str(years_common2label[-1])+'_'+modulator+str(phase)+modulator_ref+'_'+vers+'.nc'
                    elif modulator == 'none':
                        savename_results = dir_netcdf_agg+'/validation_results_season_'+variables_gcm[vv]+'_'+agg_label[ag]+'_'+model[mm]+'_vs_'+obs[oo]+'_'+domain+'_corroutlier_'+corr_outlier+'_detrended_'+detrending[det]+'_'+str(years_common2label[0])+'_'+str(years_common2label[-1])+'_'+modulator+'_'+vers+'.nc'
                    else:

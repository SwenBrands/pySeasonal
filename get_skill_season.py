...
flagfile = FLAGDIR+'/get_skill_season_'+str(vers)+'_'+str(models)+'_obs_'+str(variables_obs)+'_model_'+str(variables_gcm)+'_'+str(agg_labels)+'_'+str(modulators)+'_'+str(phases)+'.flag'

...
window = 5 #number of consecutive months during which the 3-month mean SST anomaly values provided by NOAA must surpass the magnitude of the <enso_threshold> in order to issue a Niño or Niña event 

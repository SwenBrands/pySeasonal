...
exclude_node=wn055
exectime=00:15:00 #00:12:00 for agg_label_list=('1mon') and modulator_plus_phase_list=('none') # 00:30:00 for agg_label_list=('1mon') and modulator_plus_phase_list=('none')
memory=24gb

...
# variable_list=('FWI-C4' 'SPEI-3-M-C4' 'Rx1day-C4' 'Rx5day-C4' 'TNm-C4' 'PRtot-C4' 'PRm-C4' 'TXm-C4' 'FD-C4' 'SU-C4' 'TR-C4') #bash array of variables to be processed; must coincide with <variables_gcm> in aggregate_hindcast.py
variable_list=('FWI-C4') #bash array of variables to be processed; must coincide with <variables_gcm> in aggregate_hindcast.py

...
# variable_list=('UAI' 'WSm' 'PVPOTm' 'SSRDm' 'FWIm' 'SU' 'DD' 'TR' 'FD' 'ID' 'pet-hargreaves' 'PRm' 'Rx1day' 'Tm' 'TNm' 'TXm' 'WSm' 'GDD-S' 'GDD-W' 'CGDD-S' 'CGDD-W' 'SPEI-3-M' 'msl') #bash array of variables to be processed; must coincide with <variables_gcm> in aggregate_hindcast.py

...
# variable_list=('SPEI-3-M-C4_up010' 'Rx1ay-C4_up010' 'Rx5day-C4_up010' 'TNm-C4_up010' 'PRtot-C4_up010' 'PRm-C4_up010' 'TXm-C4_up010' 'FD-C4_up010' 'SU-C4_up010' 'TR-C4_up010') #bash array of variables to be processed; must coincide with <variables_gcm> in aggregate_hindcast.py
variable_list=('Rx1day-C4_up010') #bash array of variables to be processed; must coincide with <variables_gcm> in aggregate_hindcast.py

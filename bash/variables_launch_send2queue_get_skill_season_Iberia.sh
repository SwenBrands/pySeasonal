...
exclude_node=wn055
exectime=05:00:00 #02:20:00 for agg_label_list=('1mon') and modulator_plus_phase_list=('none')
memory=156gb #154gb for agg_label_list=('1mon') and modulator_plus_phase_list=('none')
...
variable_list=('Rx1day-C4' 'Rx5day-C4' 'TXm-C4' 'FD-C4')
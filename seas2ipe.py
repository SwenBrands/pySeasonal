...
if gcm_store == 'lustre':
    home = '/lustre/gmeteo/PTICLIMA' #the root path to the input data
    server = '/lustre/gmeteo/WORK/WWW/PTICLIMA/PRODUCTS' #the product directory linked to a server
    ...
    dir_output = server+'/needs_to_be_defined'
else:

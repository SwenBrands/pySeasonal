    ...
    for ag in np.arange(len(agg_label)):
        ...
        for mm in np.arange(len(models)):
            for vv in np.arange(len(variable_fc[mm])):
                ...
                elif variable_fc[mm][vv] in ('fwi','pvpot','FWI-C4','Rx1day-C4', 'Rx5day-C4','TNm-C4','PRtot-C4','PRm-C4','TXm-C4','FD-C4','SU-C4','TR-C4','FWI-C4_up010','Rx1day-C4_up010','Rx5day-C4_up010','TNm-C4_up010','PRtot-C4_up010','PRm-C4_up010','TXm-C4_up010','FD-C4_up010', 'SU-C4_up010','TR-C4_up010'): # derived model variables

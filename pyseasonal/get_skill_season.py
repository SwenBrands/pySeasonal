...
if len(sys.argv) > 1:
    ...
    elif variables_gcm[0] in ('TR','FD','ID','pet-hargreaves','PRm','Rx1day','Rx5day','SSRDm','Tm','TNm','TXm','WSm','GDD_S','GDD_W','CGDD_S','CGDD_W','pvpot','fwi','SPEI-3-M','t2m','tp','msl','si10','ssrd'):

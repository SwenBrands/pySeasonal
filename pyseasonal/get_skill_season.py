...
if len(sys.argv) > 1:
    ...
    elif variables_gcm[0] in ('SPEI-3-M-C4_up010', 'PRtot-C4_up010', 'PRm-C4_up010', 'TNm-C4_up010', 'TXm-C4_up010', 'FD-C4_up010', 'SU-C4_up010', 'TR-C4_up010', 'Rx1day-C4_up010', 'Rx5day-C4_up010'):
    ...
    variables_gcm = ['SPEI-3-M-C4'] #model variable names in CDS format  GCM variable names have been set to ERA5 variable names from CDS in <aggregate_hindcast.py> except for <SPEI-3-M> and <SPEI-3-R>, which are paired with <SPEI-3> in <variables_obs>)

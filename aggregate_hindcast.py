...
if gcm_store == 'lustre':
    ...
    FLAGDIR = home+'/Scripts/SBrands/pyPTIclima/pySeasonal/FLAG/aggregate_hindcast'
else:
...
flagfile = FLAGDIR+'/aggregate_hindcast_'+domain+'_corrfiles_'+save_corrected_files+'_'+str(model)+'_oldvars_'+str(variables)+'_oldvars_nc_+'+str(variables_nc)+'_newvars_'+str(variables_new)+'.flag'

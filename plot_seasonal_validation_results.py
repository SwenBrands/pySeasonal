...
val_vers = 'v1m' #version of the validation results
...
agg_label = ['1mon'] #list of strings used to label to aggregation period in the output files generated by this script; the length of this list defines the number of aggregation windows

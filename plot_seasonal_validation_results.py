...
sub_domain = 'iberia' #medcof or iberia; the domain the results are plotted for; if set to <medcof>, then no sub-selection will be applied and the results for the entire medcof domain will be plotted
        ...
        for dd in range(len(model_dataset)):
            ...
            for sc in np.arange(len(scores)):
                ...
                if scores[sc] in ('crps_ensemble_skillscore_clim'):
                    ...
                    pcolorme = get_spatial_aggregation(pval.copy(),rho.copy(),critval_rho,mode_f='fraction',lat_f=yy) #.copy() is mandatory here; otherwise pval will be changed within the get_spatial_aggregation() function
                    pcolorme_meanrho = get_spatial_aggregation(pval.copy(),rho.copy(),critval_rho,mode_f='mean',lat_f=yy) #.copy() is mandatory here; otherwise pval will be changed within the get_spatial_aggregation() function
                    units_pcolor = '%'

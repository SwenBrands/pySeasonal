...
if file_system == 'myLaptop':
    ...
    dir_figs = home+'/datos/tareas/proyectos/pticlima/seasonal/results/validation/'+vers+'/'+sub_domain+'/'+str(file_years[0])+'_'+str(file_years[1]) #path to output figures file generated by this script
    ...
    dir_figs = home+'/Results/seasonal/validation/'+vers+'/'+sub_domain+'/'+str(file_years[0])+'_'+str(file_years[1]) #path to output figures file generated by this script
...
minvals_map = np.zeros((len(subperiods),len(detrending),len(variables),len(model_dataset),len(scores)))
minvals_map[:] = np.nan
        ...
        for vv in np.arange(len(variables)):
            ...
            for dd in range(len(model_dataset)):
                ...
                if model_dataset[dd] == 'ecmwf51':
                    filename_input = filename_input = 'validation_results_season_'+variables[vv]+'_'+model_dataset[dd]+'_vs_'+ref_dataset[dd]+'_'+domain+'_corroutlier_'+corr_outlier+'_detrended_'+detrending[det]+'_'+str(file_years[0])+'_'+str(file_years[1])+'_'+subperiods[su]+'_'+vers+'.nc'
                else:
        ...
        for vv in np.arange(len(variables)):
            for dd in range(len(model_dataset)):
                ...
                if model_dataset[dd] == 'ecmwf51':
                    ...
                    filename_input = 'validation_results_season_'+variables[vv]+'_'+model_dataset[dd]+'_vs_'+ref_dataset[dd]+'_'+domain+'_corroutlier_'+corr_outlier+'_detrended_'+detrending[det]+'_'+str(file_years[0])+'_'+str(file_years[1])+'_'+subperiods[su]+'_'+vers+'.nc'
                else:
                    raise Exception('ERROR: unknown entry for <model_dataset> !')
                ...
                if su == 0 and det == 0 and vv == 0 and dd == 0:
                    ...
                    binary_mask = np.zeros((len(subperiods),len(detrending),len(variables),len(model_dataset),len(scores),len(nc_results.season),len(nc_results.lead),len(y_coord),len(x_coord)),dtype='single')
                    binary_mask[:] = np.nan
                ...
                for sc in np.arange(len(scores)):
                    ...
                    if scores[sc] in ('crps_ensemble_skillscore_clim','crps_ensemble_skillscore_rand','roc_auc_lower_tercile_skillscore','roc_auc_upper_tercile_skillscore'):
                        ...
                        savename_mean = dir_figs+'/'+subperiods[su]+'/'+variables[vv]+'/pcolor_arealmean_'+variables[vv]+'_'+scores[sc]+'_'+domain+'_'+sub_domain+'_'+model_dataset[dd]+'_vs_'+score_ref+'_corr_outlier_'+corr_outlier+'_detrended_'+detrending[det]+'_'+str(file_years[0])+'_'+str(file_years[1])+'_'+subperiods[su]+'_'+vers+'.'+figformat
                        savename_fraction = dir_figs+'/'+subperiods[su]+'/'+variables[vv]+'/pcolor_arealfraction_'+variables[vv]+'_'+scores[sc]+'_'+domain+'_'+sub_domain+'_'+model_dataset[dd]+'_vs_'+score_ref+'_corr_outlier_'+corr_outlier+'_detrended_'+detrending[det]+'_'+str(file_years[0])+'_'+str(file_years[1])+'_'+subperiods[su]+'_'+vers+'.'+figformat
                        ...
                        savename_fraction = dir_figs+'/'+subperiods[su]+'/'+variables[vv]+'/pcolor_arealfraction_'+variables[vv]+'_'+scores[sc]+'_'+domain+'_'+sub_domain+'_'+model_dataset[dd]+'_vs_'+score_ref+'_corr_outlier_'+corr_outlier+'_detrended_'+detrending[det]+'_testlvl_'+str(round(critval_rho*100))+'_'+str(file_years[0])+'_'+str(file_years[1])+'_'+subperiods[su]+'_'+vers+'.'+figformat
                        savename_mean = dir_figs+'/'+subperiods[su]+'/'+variables[vv]+'/pcolor_arealmean_'+variables[vv]+'_'+scores[sc]+'_'+domain+'_'+sub_domain+'_'+model_dataset[dd]+'_vs_'+score_ref+'_corr_outlier_'+corr_outlier+'_detrended_'+detrending[det]+'_testlvl_'+str(round(critval_rho*100))+'_'+str(file_years[0])+'_'+str(file_years[1])+'_'+subperiods[su]+'_'+vers+'.'+figformat
                        ...
                        savename_mean = dir_figs+'/'+subperiods[su]+'/'+variables[vv]+'/pcolor_aerealmean_'+variables[vv]+'_'+scores[sc]+'_'+domain+'_'+sub_domain+'_'+model_dataset[dd]+'_vs_'+score_ref+'_corr_outlier_'+corr_outlier+'_detrended_'+detrending[det]+'_'+str(file_years[0])+'_'+str(file_years[1])+'_'+subperiods[su]+'_'+vers+'.'+figformat
                        savename_fraction = dir_figs+'/'+subperiods[su]+'/'+variables[vv]+'/pcolor_aerealfraction_'+variables[vv]+'_'+scores[sc]+'_'+domain+'_'+sub_domain+'_'+model_dataset[dd]+'_vs_'+score_ref+'_corr_outlier_'+corr_outlier+'_detrended_'+detrending[det]+'_'+str(file_years[0])+'_'+str(file_years[1])+'_'+subperiods[su]+'_'+vers+'.'+figformat
                        ...
                        savename_mean = dir_figs+'/'+subperiods[su]+'/'+variables[vv]+'/pcolor_arealmean_'+variables[vv]+'_'+scores[sc]+'_'+domain+'_'+sub_domain+'_'+model_dataset[dd]+'_vs_'+score_ref+'_corr_outlier_'+corr_outlier+'_detrended_'+detrending[det]+'_'+str(file_years[0])+'_'+str(file_years[1])+'_'+subperiods[su]+'_'+vers+'.'+figformat
                        savename_fraction = dir_figs+'/'+subperiods[su]+'/'+variables[vv]+'/pcolor_arealmean_'+variables[vv]+'_'+scores[sc]+'_'+domain+'_'+sub_domain+'_'+model_dataset[dd]+'_vs_'+score_ref+'_corr_outlier_'+corr_outlier+'_detrended_'+detrending[det]+'_'+str(file_years[0])+'_'+str(file_years[1])+'_'+subperiods[su]+'_'+vers+'.'+figformat
                    ...
                    if scores[sc] in ('relbias','bias') and detrending[det] == 'yes':
                        ...
                        for sea in np.arange(len(seasons)):
                            for ll in np.arange(len(leads)):
                                ...
                                savename = dir_figs+'/'+subperiods[su]+'/'+variables[vv]+'/maps/'+scores[sc]+'/map_'+variables[vv]+'_'+seasons[sea]+'_'+leads[ll]+'_'+scores[sc]+'_'+critval_label+'_'+domain+'_'+sub_domain+'_'+model_dataset[dd]+'_vs_'+score_ref+'_corr_outlier_'+corr_outlier+'_detrended_'+detrending[det]+'_'+str(file_years[0])+str(file_years[1])+'_'+subperiods[su]+'_'+vers+'.'+figformat
                                cbarlabel = scores[sc]
...
for sc in np.arange(len(scores)):
    if scores[sc] in ('rpc','bias','relbias','pearson_r','spearman_r','crps_ensemble_skillscore_clim','crps_ensemble_skillscore_rand','roc_auc_lower_tercile_skillscore','roc_auc_upper_tercile_skillscore'):
        ...
        binary_mask_score_i = xr.DataArray(binary_mask_score_i,coords=[subperiods,detrending,variables,model_dataset,nc_results.season,nc_results.lead,nc_results.y,nc_results.x],dims=['subperiod','detrended','variable', 'model', 'season', 'lead', 'y', 'x'], name=scores[sc]+'_binary')
...
nc_results.close()
#savename_netcdf = dir_netcdf+'/binary_validation_results_pticlima_'+domain+'_'+sub_domain+'_'+str(file_years[0])+'_'+str(file_years[1])+'_'+subperiods[su]+'_'+vers+'.nc'
savename_netcdf = dir_netcdf+'/binary_validation_results_pticlima_'+domain+'_'+sub_domain+'_'+str(file_years[0])+'_'+str(file_years[1])+'_'+vers+'.nc'
